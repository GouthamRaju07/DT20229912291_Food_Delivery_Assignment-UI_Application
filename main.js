...
$(document).ready(function () {
    $.getJSON('https://sfxz3aprr7.execute-api.us-east-1.amazonaws.com/Finish1/getmenuinformation', function (foods) {
        ...
        $.each(foods, function (key, value) {
            ...
            foodData += '<td> <div class="img-container"> <img src="' + value.foodImage + ' "alt="" border=3 height=150 width=180 class="img" /> <a id="id_1" value=' + x + ' class="fa fa-shopping-cart" href = "#"   ></a> </div></td>';
            foodData += '</tr>';
            x++;
        });
