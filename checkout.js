    ...
    if (cusName !== null && cusName !== '' && cusAddr !== null && cusAddr !== '' && cusCity !== null && cusCity !== '' && cusState !== null && cusState !== '' && cusZipcode !== null && cusZipcode !== '') {
        ...
        if (checkoutStatus == true) {
            $.ajax({
                ...
                success: function () {
                    alert("Your order have been recorded successfully \nYour Order details and Order Number are saved in View Cart ");
                },
                error: function () {
                    alert("Your order have been recorded successfully \nYour Order details and Number are saved in View Cart");
                }
            });
            clearOrder()
        }
