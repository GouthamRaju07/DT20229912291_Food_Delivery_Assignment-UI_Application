...
$(document).ready(function () {
    $.getJSON(api_foods_url, function (foods) {
        ...
        $.each(foods, function (key, value) {
            ...
            foodData += '<td> <div class="img-container"> <img src="' + value.foodImage + ' "class="image" border=3 height=100 width=100 class="img" /> <a class="add-cart" href="#">Add Cart</a>  </div></td>';
            foodData += '</tr>';
        });
